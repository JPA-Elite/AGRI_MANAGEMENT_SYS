...
export default function ViewEquipmentRequestModal({ isOpen, setIsOpen, data }) {
    return (
                ...
                <div className="fixed inset-0 flex items-center justify-center p-4">
                    <Dialog.Panel className="mx-auto w-full max-w-3xl rounded-lg bg-white p-6">
                        <div className="border-b pb-4 mb-4">
                            <Dialog.Title className="text-lg font-medium">Equipment Request Details</Dialog.Title>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-sm text-gray-900">{data?.equipment_type}</p>
                            </div>
                            <div>
                        ...
                        <div className="mt-4">
                            ...
                            <p className="mt-1 text-sm text-gray-900">{data?.purpose}</p>
                        </div>
                        {data?.remarks && (
                            <div className="mt-4">
