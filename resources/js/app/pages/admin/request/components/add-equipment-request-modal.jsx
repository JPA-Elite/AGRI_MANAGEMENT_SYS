...
import { EQUIPMENT_TYPES } from "@/app/constants/general";

export default function AddEquipmentRequestModal({ isOpen, setIsOpen }) {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            await axios.post('/api/equipment-requests', formData);
            ...
            await Swal.fire({
                title: "Success!",
                text: "Equipment request has been submitted",
                icon: "success",
                ...
                <div className="fixed inset-0 flex items-center justify-center p-4">
                    <Dialog.Panel className="mx-auto w-full max-w-4xl h-[90vh] rounded-lg bg-white p-6 overflow-y-auto">
                        <div className="sticky top-0 bg-white pb-4 mb-4 border-b">
                            <Dialog.Title className="text-xl font-medium">Add Equipment Request</Dialog.Title>
