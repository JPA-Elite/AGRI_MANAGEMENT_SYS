                                                        ...
                                                        <div class="space-y-4">
                                                            <div class="flex items-center">
                                                                <input
                                                                    ...
                                                                    id="farmer"
                                                                    name="role"
                                                                    checked={formData.livelihoods.some((res) => res.name === 'Farmer')}
                                                                    value="Farmer"
                                                                    onChange={(
                                                                        e
                                                                    ) => {
                                                            ...
                                                            <div class="flex items-center">
                                                                <input
                                                                    ...
                                                                    id="farmworker"
                                                                    name="role"
                                                                    checked={formData.livelihoods.some((res) => res.name === 'Farmworker/Laborer')}
                                                            ...
                                                            <div class="flex items-center">
                                                                <input
                                                                    ...
                                                                    id="agriYouth"
                                                                    name="agriYouth"
                                                                    checked={formData?.livelihoods?.some(
                                                                        (res) =>
                                                                            res.name ==
                                                                            "Agri Youth"
                                                                    )}
