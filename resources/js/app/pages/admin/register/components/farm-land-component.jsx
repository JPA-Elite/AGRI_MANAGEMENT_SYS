...
export default function FarmLandComponent() {
    ...
    const deleteParcel = (index) => {
        ...
        const updatedParcels = form.parcels.filter((_, i) => i !== index);

        console.log("Updated parcels after deletion:", {
            ...form,
    ...
    const handleInputChange = (e, index) => {
        ...
        // Update the parcels array immutably
        const updatedParcels = form.parcels.map((parcel, i) => {
            if (i === index) {
                return { ...parcel, [name]: value }; // Update the specific field
            }
            return parcel; // Return the rest of the parcels unchanged
        });
                        ...
                        onClick={() =>
                            dispatch(
                                setForm({
                                    ...form,
                                    parcels: [
                                        ...form.parcels, // Spread the current parcels
                                        {}, // Add a new empty parcel object
                                    ],
                                })
                            )
                        }
