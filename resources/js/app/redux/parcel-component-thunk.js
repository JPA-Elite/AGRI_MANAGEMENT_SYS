...
export async function get_parcel_component_thunk() {
...
export async function store_parcel_component_thunk(data) {
    return async function (dispatch, getState) {
...
export async function delete_parcel_component_thunk(id) {
    return async function (dispatch, getState) {
...
export async function update_parcel_component_thunk(data) {
    return async function (dispatch, getState) {
...
export async function get_parcel_component_by_id_thunk(id) {
    return async function (dispatch, getState) {
