...
import {
    ...
    get_organization_by_id_service,
    get_organization_service,
    store_organization_service,
...
export function get_organization_thunk() {
    return async function (dispatch, getState) {
        ...
        dispatch(organizationSlice.actions.setOrganizations(res));
        return res.data;
    };
}
...
export function store_organization_thunk(data) {
    return async function (dispatch, getState) {
        const res = await store_organization_service(data);
        return res.data;
    };
}
